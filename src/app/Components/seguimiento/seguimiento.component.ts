        ...
        .subscribe(
          (data) => {
            ...
            if (this.reparacionBuscada.notasreparacion && this.reparacionBuscada.notasreparacion.length > 0) {
              this.reparacionBuscada.notasreparacion.sort((a: { fecha: string | number | Date; }, b: { fecha: string | number | Date; }) => new Date(b.fecha).getTime() - new Date(a.fecha).getTime());
