...
export class ProvidersComponent implements OnInit {
  ...
  navigateToUpdateProveedor(id: string, nombre: string): void {
    this.router.navigateByUrl(`/proveedores/update`, { state: { nombre: nombre, id: id } });
  }
  ...
  abrirModalModificacion(proveedorId: string, proveedorNombre: string, proveedorDireccion: string, proveedorTelefono: string, proveedorCorreo: string) {
